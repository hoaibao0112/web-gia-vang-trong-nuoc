  ...
  return (
    <footer className="bg-gray-900 text-gray-300 py-12 mt-16">
      <div className="container mx-auto max-w-7xl px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          <h3 className="text-white text-lg font-bold mb-4">GIÁ VÀNG TRONG NƯỚC</h3>
          <p className="text-sm mb-2">Giấy chứng nhận ĐKDN số: 0304618765 do Sở KH&ĐT TP.HCM cấp ngày 20/09/2006.</p>
          <p className="text-sm mb-2">Trụ sở chính: 306 Bùi Hữu Nghĩa, Phường 2, Quận Bình Thạnh, TP.HCM</p>
          <p className="text-sm mb-2">Điện thoại: +84 28 3841 0068</p>
          <p className="text-sm">Email: info@mihong.vn</p>
        </div>
        
        <div>
          <h3 className="text-white text-lg font-bold mb-4">CHĂM SÓC KHÁCH HÀNG</h3>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li><Link href="#" className="hover:text-white transition-colors">Giới thiệu Giá Vàng Trong Nước</Link></li>
        ...
        <div>
          ...
          <div className="flex space-x-4 mb-6">
            <Link href="#" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-yellow-500 hover:text-gray-900 transition-colors">
          ...
          <p className="text-xs text-gray-500 mt-8">© 2026 Giá Vàng Trong Nước. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
